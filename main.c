...
* File Name: main.c
*
* Description: This application demonstrates various WLAN power states by
* configuring the WLAN to these modes: Power Save with Throughput, Power Save
* without Throughput, and Power Save Disabled.
*
...
#define mainDEVICE_NICK_NAME                "wlan_lowpower"
...
void vApplicationDaemonTaskStartupHook(void)
{
    ...
    APP_INFO(("================================================\n"));
    APP_INFO(("AWS IoT and FreeRTOS for PSoC 6: WLAN Low Power\n"));
    APP_INFO(("================================================\n\n"));
    ...
    if(SYSTEM_Init() == pdPASS)
    {
        ...
        /* Initializes the application task which configures the
         * WLAN power save mode and then suspends the lwIP network stack.
         */
        InitApplication();
    }
}
...
{
    ERR_INFO(("ERROR: Malloc failed to allocate memory\r\n"));
    taskDISABLE_INTERRUPTS();
...
void vApplicationStackOverflowHook(TaskHandle_t xTask,
                                   char *pcTaskName)
{
    ERR_INFO(("ERROR: stack overflow with task %s\r\n", pcTaskName));
